            ...
            >
              ...
              <div className="p-3 flex flex-col lg:gap-2">
                ...
                <div className="flex lg:justify-between lg:items-center lg:flex-row flex-col gap-3 ">
                  ...
                  <button className="lg:block hidden bg-gray-700  border  text-white border-gray-300 cursor-pointer py-1 px-4 rounded-full transition duration-200">
                    Buy Now
                  </button>

                  <button className="lg:hidden rounded-full bg-gray-800 cursor-pointer text-white py-1 w-full px-2">
                    Buy Now
                  </button>
