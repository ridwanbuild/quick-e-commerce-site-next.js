     ...
     <div className="py-16">
      <div>
            ...
            >
              ...
              <div className="p-3 flex flex-col lg:gap-2">
                ...
                <div className="flex lg:justify-between lg:items-center lg:flex-row flex-col gap-3 ">
                  ...
                  <Link href={`/shop/${product.id}`} className="lg:block hidden bg-gray-700  border  text-white border-gray-300 cursor-pointer py-1 px-4 rounded-full transition duration-200">
                    Buy Now
                  </Link>

                  <Link href={`/shop/${product.id}`} className="lg:hidden text-center rounded-full bg-gray-800 cursor-pointer text-white py-1 w-full px-2">
                    Buy Now
                  </Link>
        ...
        <div className="flex items-center justify-center pt-10">
          <Link
            href={"/shop"}
            className="border rounded-full border-gray-400 text-gray-500 px-6 py-1"
          >
            See More
          </Link>
        </div>
